...
export const level001: LevelDefinition = {
  ...
  width: 7, height: 5, objective: "Forma DOOR IS OPEN y llega a EXIT IS WIN.",
  blocks: [
    { id: "player", kind: "object", noun: "PLAYER", position: { row: 3, column: 1 } },
    { id: "door", kind: "object", noun: "DOOR", position: { row: 2, column: 5 } },
    { id: "exit", kind: "object", noun: "EXIT", position: { row: 3, column: 6 } },
    ...
    { id: "w-exit", kind: "word", wordKind: "noun", value: "EXIT", position: { row: 4, column: 3 } },
    { id: "w-is-3", kind: "word", wordKind: "operator", value: "IS", position: { row: 4, column: 4 } },
    { id: "w-win", kind: "word", wordKind: "property", value: "WIN", position: { row: 4, column: 5 } }
  ]
};
